"""
Ablation: DR-LiteNet (full hybrid fusion) WITHOUT Adaptive SMOTE.
Standard end-to-end training with uniform CE loss.
"""
import sys
...
from baselines._baseline_engine import train_baseline_fold
from src.model import build_model
from src.utils import get_device, set_seed

MODEL_NAME = "dr_litenet_no_smote"
...
def run(fold_idx: int = 0, num_epochs: int = cfg.MAX_EPOCHS,
    ...
    return train_baseline_fold(
        ...
        use_class_weights=False, use_handcrafted=True,
